...
function update_github_release() {
    ...
    gh release upload --repo "$GITHUB_REPOSITORY" --clobber "$TAG" \
        config/crd/bases/migrations.kubevirt.io_multinamespacevirtualmachinestoragemigrationplans.yaml \
        config/crd/bases/migrations.kubevirt.io_multinamespacevirtualmachinestoragemigrations.yaml \
        config/crd/bases/migrations.kubevirt.io_virtualmachinestoragemigrationplans.yaml \
        config/crd/bases/migrations.kubevirt.io_virtualmachinestoragemigrations.yaml \
